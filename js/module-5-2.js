...
//!======================================
//2 Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких gender дорівнює 'Male'.

// const maleHeroes = heroes => heroes.filter(hero => hero.appearance.gender === 'Male');

// console.log(maleHeroes(heroes));

//!======================================
//3 Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких eyeColor дорівнює 'Blue'.

// const heroesWithBlueEyes = heroes => heroes.filter(hero => hero.appearance.eyeColor === 'Blue');

// console.log(heroesWithBlueEyes(heroes));

//!======================================
//4 Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких hairColor дорівнює 'Black'.

// const heroesWithBlackHair = heroes => heroes.filter(hero => hero.appearance.hairColor === 'Black');

// console.log(heroesWithBlackHair(heroes));

//!======================================
// 7 Напиши функцію, яка приймає масив героїв та повертає масив героїв, у яких powerstats.power більше ніж 80.

// const HeroesWithPower80AndMore = heroes => heroes.filter(hero => hero.powerstats.power >= 80);

// console.log(HeroesWithPower80AndMore(heroes));

//!======================================
// 9 Напиши функцію, яка приймає масив героїв та повертає героя з name рівним 'Doctor Strange'.

// const findDoctorStrange = heroes => heroes.filter(hero => hero.name === 'Doctor Strange')[0];

// console.log(findDoctorStrange(heroes));

//!======================================
// 10 Напиши функцію, яка приймає масив героїв та повертає героя з максимальним значенням powerstats.strength.

// const heroWithMaxStr = heroes => heroes.reduce((max, hero) => hero.powerstats.strength > max.powerstats.strength ? hero : max,heroes[0]);

// console.log(heroWithMaxStr(heroes));

//!======================================
// 16 Напиши функцію, яка приймає масив героїв та сортує його за зростанням powerstats.intelligence.

// const sortedHeroesByInt = heroes => heroes.toSorted((a,b)=>a.powerstats.intelligence - b.powerstats.intelligence)

// console.log(sortedHeroesByInt(heroes));

//!======================================
// 18 Напиши функцію, яка приймає масив героїв та сортує його за алфавітом по name.

// const sortedHeroesByName = heroes => heroes.toSorted((a,b)=>a.name.localeCompare(b.name));

// console.log(sortedHeroesByName(heroes));

//!======================================
// 19 Напиши функцію, яка приймає масив героїв та перевіряє, чи є хоча б один герой з alignment рівним 'bad'.

// const someHeroesAlignmentBad = heroes => heroes.some(hero => hero.biography.alignment === 'bad');

// console.log(someHeroesAlignmentBad(heroes));

//!======================================
// 20 Напиши функцію, яка приймає масив героїв та перевіряє, чи всі герої мають alignment рівним 'good'.

// const everyHeroesAlignmentGood = heroes => heroes.every(hero => hero.biography.alignment === 'good');

// console.log(everyHeroesAlignmentGood(heroes));

//!======================================
// 22 Напиши функцію, яка приймає масив героїв та перевіряє, чи всі герої мають race, відмінний від null.

// const everyHeroesRaseNotNull = heroes => heroes.every(hero => hero.appearance.race != null);

// console.log(everyHeroesRaseNotNull(heroes));

//!======================================
// 25 Напиши функцію, яка приймає масив героїв та повертає масив довжин масиву aliases кожного героя.

// const HeroesAliasesLength = heroes => heroes.map(hero => hero.biography.aliases.length);

// console.log(HeroesAliasesLength(heroes));

//!======================================
// 26 Напиши функцію, яка приймає масив героїв та повертає героя, у якого найбільше aliases.

// const HeroeAliasesMaxLength = heroes => heroes.reduce((maxHero,hero) => hero.biography.aliases.length > maxHero.biography.aliases.length ? hero : maxHero, heroes[0]);

// console.log(HeroeAliasesMaxLength(heroes));

//!======================================
// 29 Напиши функцію, яка приймає масив героїв та повертає масив героїв, які мають у groupAffiliation згадку про 'Avengers'.

// const HeroesGroupAffiliationHaveAvengers = heroes => heroes.filter(hero => hero.connections.groupAffiliation.includes('Avengers'))
